...
class CreateStrategy_Audience(BaseModel):
...
class ReadStrategy_Audience(BaseModel):
    id: uuid.UUID
...
class UpdateStrategy_Audience(BaseModel):
    interests: Optional[str] = Field(default=None)
    journey: Optional[str] = Field(default=None)
    keywords: Optional[str] = Field(default=None)
    geo_audience: Optional[List[str]]
...
class ReadStrategy_Audiences(BaseModel):
    data: list[Optional[ReadStrategy_Audience]]
