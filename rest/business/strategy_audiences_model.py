...
class Strategy_AudienceModel(BaseModel):
    __tablename__ = 'strategy_audiences'
    ...
    strategy__details = relationship("StrategyModel", back_populates='strategy_audiences', lazy='subquery')
