...
class ZeNotifyClient:
    ...
    async def create_notification(self, recipients: List[str], template: str, provider:str, params:dict, target:str) -> Union[dict, None]:
        """
        ...
        return await self._call(
            url=f"{ZENOTIFY_BASE_URL}/notifications/",
            payload=payload,
